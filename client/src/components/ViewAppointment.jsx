...
const ViewAppointment = () => {
  ...
  const UpdateStatus = (id) => {
    navigate("/update_status_appointment/" + id);
  };
  useEffect(() => {
        ...
        <div className="top-products-area py-3">
          <div className="container">
            <div className="section-heading d-flex align-items-center justify-content-between">
              <h6>Search Appointment Details</h6>
            </div>
            ...
            {filteredData.length > 0 ? (
                ...
                {filteredData.map((appointment) => (
                  <div key={appointment._id} className="col-12 col-md-6">
                    ...
                    >
                      <div className="card-body">
                        <a className="product-title d-block">
                          Hospital Email: <b>{appointment.hospitalemail}</b>
                        </a>
                        <a className="product-title d-block">
                          Patient Name:: <b> {appointment.patient_name}</b>
                        </a>
                        <a className="product-title d-block">
                          Doctor Name:: <b> {appointment.doctor_name}</b>
                        </a>

                        <a className="product-title d-block">
                          Reason: <b>{appointment.reason}</b>
                        </a>
                        <a className="product-title d-block">
                          Appointment Date:{" "}
                          <b>
                            ...
                            ).toLocaleDateString("en-GB", timeOptions)}{" "}
                          </b>
                        </a>
                    ...
                    <a
                      className="btn btn-danger"
                      onClick={() =>
                        history(appointment.patemail, appointment.patient_name)
                      }
                    >
                      Medical History
                    </a>
              ...
              <p>
                No appointment details found for the specified email or search
                term.
              </p>
            )}
          </div>
