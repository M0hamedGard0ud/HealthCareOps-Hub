...
const PatientProfile = () => {
  ...
  const EditProfile = (id) => {
    navigate("/edit_patientprofile/" + id);
  };

  const [filteredData, setProfileData] = useState([]);
  ...
  useEffect(() => {
    const fetchProfileData = async () => {
      try {
        ...
        const patemail = decodeURIComponent(
        ...
        const filteredProfile = data.filter(
          (users) => users.email === patemail
        );
